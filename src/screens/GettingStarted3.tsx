...
const GettingStarted3: React.VFC<any> = ({ navigation }) => {
    return <SafeAreaView style={styles.GettingStarted3View}>
        <Text style={styles.txtTitle}>Keep track of your progress</Text>
        <Image source={require('../../assets/asset3.png')} style={styles.img}/>
        ...
        <View style={styles.nav}>
            ...
            <Image source={require('../../assets/asset3-1.png')}/>
            <TouchableOpacity onPress={() => navigation.navigate('GettingStarted4')}>
